...
database=protein_databases/zebrafish/zebrafish

if [ ! -s data/blast_zebrafish/blast_output_${SGE_TASK_ID}.tab ]; then
    $blastx -db $database -query $fasta -out data/blast_zebrafish/blast_output_${SGE_TASK_ID}.tab -outfmt 6 -num_threads 1
fi
